...
var ldinsp = function(){
if(typeof window.__inspld != "undefined") return; window.__inspld = 1; var insp = document.createElement('script'); insp.type = 'text/javascript'; insp.async = true; insp.id = "inspsync"; insp.src = ('https:' == document.location.protocol ? 'https' : 'http') + '://cdn.inspectlet.com/inspectlet.js?wid=1054286090&r=' + Math.floor(new Date().getTime()/3600000); var x = document.getElementsByTagName('script')[0]; x.parentNode.insertBefore(insp, x); };
setTimeout(ldinsp, 0);
})();
</script>
...
<link rel="canonical" href="https://artsnewsnow.com" />
...
<div class="get_overlay_for_active_function">
<?php
    ...
    <div class="wrapper afclr">
        <div class="header_ad_banner_inner afclr">
            <div class="header_ad_sec afclr">
                <a href="<?php echo $header_ad_link; ?>" target="_blank"><img src="<?php echo esc_url($header_ad['url']); ?>" alt="<?php echo esc_attr($header_ad['alt']); ?>" /></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="sticky_header afclr">
                    ...
                    <div class="top_center_menu">
                        ...
                        <i></i>
                            ...
                            <div class="h_nav_menu_outer afclr">
                                    ...
                                    <div class="h_nav_bottom_btn afclr">
                                        <a href="#newsletter" class="site_btn nn_newsletter"> E-NEWS SIGN-UP </a>
                                    </div>
                                </div>
	...
	<header class="main_header_section afclr">
        <div class="h_haeder_top_mobile afclr">
		...
		<div class="main-top-section afclr">
			<div class="wrapper afclr">
				<div class="main-top-inner">
                    <div class="h_social_header_section hh_social_header_soc afclr">
                        <div class="newsletter_quote_btn afclr">
                            <a href="#newsletter" class="site_btn">E-NEWS SIGNUP</a>
                        </div>
                        <ul>
							<?php
								if(!empty($facebook_link)){
                        ...
                        <div class="main-left-menu">
                            ...
                            <div class="site-menu afclr">
                                ...
                                <div class="h_nav_menu_outer afclr">
                                    ...
                                    <div class="h_nav_bottom_btn afclr">
                                        <a href="#newsletter" class="site_btn nn_newsletter">E-NEW SIGNUP</a>
                                    </div>
                                </div>
                ...
                <div class="h_shop_header_section afclr">
                     <ul>
                        <li><a href="javascript:void(0);" id="search_content_btn">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M448 449L301.2 300.2c20-27.9 31.9-62.2 31.9-99.2 0-93.1-74.7-168.9-166.5-168.9C74.7 32 0 107.8 0 200.9s74.7 168.9 166.5 168.9c39.8 0 76.3-14.2 105-37.9l146 148.1 30.5-31zM166.5 330.8c-70.6 0-128.1-58.3-128.1-129.9S95.9 71 166.5 71s128.1 58.3 128.1 129.9-57.4 129.9-128.1 129.9z"/></svg></a>
                            <div class="search_area_container">
                                    <?php echo do_shortcode('[ivory-search id="1253" title="Default Search Form"]'); ?>
                            </div>
                        </li>

                         <?php /* ?><li><a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M352 160v-32C352 57.42 294.579 0 224 0 153.42 0 96 57.42 96 128v32H0v272c0 44.183 35.817 80 80 80h288c44.183 0 80-35.817 80-80V160h-96zm-192-32c0-35.29 28.71-64 64-64s64 28.71 64 64v32H160v-32zm160 120c-13.255 0-24-10.745-24-24s10.745-24 24-24 24 10.745 24 24-10.745 24-24 24zm-192 0c-13.255 0-24-10.745-24-24s10.745-24 24-24 24 10.745 24 24-10.745 24-24 24z"/></svg></a></li> <?php */ ?>
                    </ul>
