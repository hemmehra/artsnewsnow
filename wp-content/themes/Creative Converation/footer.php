...
<section id="newsletter">
        ...
        <div class="form_section_main afclr" style="background:url('<?php echo $newsletter_section_background_image['url']; ?>');background-size:cover;">
...
<!--   Footer -->
	...
	<footer>
        ...
        <div class="copy_center_section afclr">
            <div class="wrapper afclr">
                <div id="copy">Copyright &copy; <?php echo date('Y'); ?> Arts News Now  | All Rights Reserved | <a href="#">Privacy Policy</a> | <a href="#">Terms and Conditions</a>
                </div>
            </div>
        </div>
...
<script>
      var swiper = new Swiper(".event_block_for_mobile_slider", {
        slidesPerView: 1,
        spaceBetween: 20,
        speed:1000,
        loop: true,
